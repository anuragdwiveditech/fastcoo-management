 ...
 */
namespace Fastcoo\Management\Block\Adminhtml\Order;
...
class Create extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->buttonList->update('save', 'label', __('Submitt Ordert'));
    ...
    public function getCancelUrl()
    {
        if ($this->_sessionQuote->getOrder()->getId()) {
            $url = $this->getUrl('fastcoo/order/view', ['order_id' => $this->_sessionQuote->getOrder()->getId()]);
        } else {
            $url = $this->getUrl('fastcoo/*/cancel');
        }
    ...
    {
        return $this->getUrl('fastcoo/' . $this->_controller . '/');
    }
}
