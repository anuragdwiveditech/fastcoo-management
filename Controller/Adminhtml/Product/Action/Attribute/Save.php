 ...
 */
namespace Fastcoo\Management\Controller\Adminhtml\Product\Action\Attribute;
...
class Save extends \Magento\Catalog\Controller\Adminhtml\Product\Action\Attribute implements HttpPostActionInterface
{
    ...
    public function execute()
    {
        if (!$this->_validateProducts()) {
            return $this->resultRedirectFactory->create()->setPath('fastcoo/product/', ['_current' => true]);
        }
        ...
        return $this->resultRedirectFactory->create()->setPath('fastcoo/product/', ['store' => $storeId]);
    }
