...
class Edit extends \Magento\Catalog\Controller\Adminhtml\Product implements HttpGetActionInterface
{
    ...
    public function execute()
    {
        ...
        if ($productId && !$product->getEntityId()) {
            ...
            return $resultRedirect->setPath('fastcoo/*/');
        } elseif ($productId === 0) {
            /** @var \Magento\Backend\Model\View\Result\Redirect $resultRedirect */
            $resultRedirect = $this->resultRedirectFactory->create();
        ...
        // keep active menu as Catalog so menu highlight remains; change if you have fastcoo menu
        ...
        if (!$this->storeManager->isSingleStoreMode()
            ...
            $switchBlock->setDefaultStoreName(__('Default Values'))
                ...
                ->setSwitchUrl(
                    // switch url should also point to fastcoo route
                    $this->getUrl(
                        'fastcoo/*/*',
